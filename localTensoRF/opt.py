...
def config_parser(cmd=None):  # args里要加Frontend需要的参数，在goslam-run.py里——wcd 20240131
    ...
    #)
    parser.add_argument(
       "--pose_config", type=str, help="pose config file path", default="/data/localrf-main-latest/localTensoRF/pose_configs/indoor.yaml"
    ) #how to obtain pose config from args.pose_config——wcd 20230729
    #parser.add_argument(
    #)is_config_file=True
    parser.add_argument(
    ...
    ## training options
    # learning rate
    #parser.add_argument("--lr_R_init", type=float, default=5e-3, help="Rotation learning rate")#r、t改lr
    ...
    parser.add_argument("--loss_flow_weight_inital", type=float, default=1)#original:1
    ...
    # parser.add_argument("--pose_weight", type=float, default=1) #——wcd 20230728
